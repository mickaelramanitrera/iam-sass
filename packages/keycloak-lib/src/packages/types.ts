...
export type KeycloakOrganizationPayload = AtLeast<KeycloakOrganizationObject, 'name'>;
...
export type KeycloakUserUpdatePayload = Pick<KeycloakUserCreationPayload, 'enabled'>;
